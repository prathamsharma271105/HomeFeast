    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Clock size={16} color={isDelivered ? '#2B8A3E' : '#E8590C'} />
              <span style={{ fontSize: '13px', fontWeight: 800, color: isDelivered ? '#2B8A3E' : '#E8590C' }}>
                {isDelivered
                  ? 'Delivered Fresh & Hot 🍲'
                  : activeIndex === 3
                ...
                >
                  <div
                    style={{
                      ...
                      justifyContent: 'center',
                      flexShrink: 0,
                      boxShadow: isActive ? '0 0 0 4px rgba(232, 89, 12, 0.2)' : 'none',
                      transition: 'all 0.2s ease'
                    }}
                  >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <h4
                        style={{
                          fontSize: '13.5px',
                          fontWeight: 800,
                          color: isActive ? '#E8590C' : isCompleted ? '#1C1917' : '#78716C',
                          margin: 0
                        }}
                      >
                        {step.label}
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  gap: '6px',
                  cursor: 'pointer',
                  boxShadow: '0 2px 8px rgba(232, 89, 12, 0.15)',
                  transition: 'all 0.15s ease'
                }}
                onMouseEnter={e => {
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: '18px', fontWeight: 900, color: '#E8590C' }}>
