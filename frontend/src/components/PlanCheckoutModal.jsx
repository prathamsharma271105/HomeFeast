  ...
  return (
    ...
    >
      {imgLoaded ? (
        ...
        >
          <QrCode size={46} color="#E8590C" />
          <span style={{ fontSize: '9.5px', fontWeight: 700, color: '#E8590C' }}>{label}</span>
        </div>
      )}

      <div style={{ fontSize: '11px', fontWeight: 900, color: '#E8590C', marginTop: '4px' }}>
        Exact: ₹{amount}
      </div>
    </div>
  );
      ...
      >
        ...
        <div
          style={{
            background: '#FFF9F2',
            padding: '12px 24px',
            borderBottom: '1.5px solid #EAE3D9',
            display: 'flex',
        ...
        >
          <div>
            ...
            <div style={{ fontSize: '22px', fontWeight: 900, color: '#E8590C', display: 'flex', alignItems: 'baseline', gap: '6px' }}>
              ₹{price}
              <span style={{ fontSize: '12.5px', color: '#57534E', fontWeight: 500 }}>
                (₹{costPerMeal}/meal)
              </span>
            </div>
          </div>
        ...
        >
                ...
                {['Vegetarian', 'Pure Jain', 'Non-Veg Mixed'].map(pref => (
                  <button
                    ...
                    style={{
                      padding: '7px',
                      borderRadius: '8px',
                      border: dietPreference === pref ? '2px solid #E8590C' : '1px solid #EAE3D9',
                      background: dietPreference === pref ? '#FFF4E6' : '#FFFFFF',
                      color: dietPreference === pref ? '#E8590C' : '#57534E',
                      fontSize: '12px',
                      fontWeight: 700,
                      cursor: 'pointer',
          ...
          <div style={{ borderTop: '1.5px solid #EAE3D9', paddingTop: '14px' }}>
            <div style={{ fontSize: '13px', fontWeight: 800, color: '#1C1917', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <CreditCard size={15} color="#E8590C" />
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    padding: '7px 4px',
                    borderRadius: '8px',
                    border: paymentMethod === tab.id ? '2px solid #E8590C' : '1px solid #EAE3D9',
                    background: paymentMethod === tab.id ? '#FFF4E6' : '#FAFAF9',
                    color: paymentMethod === tab.id ? '#E8590C' : '#57534E',
                    fontSize: '11px',
                    fontWeight: 700,
                    cursor: 'pointer',
                    display: 'flex',
            ...
            {paymentMethod === 'UPI' && (
              <div
                style={{
                  ...
                  borderRadius: '14px',
                  padding: '14px',
                  boxShadow: '0 2px 8px rgba(232, 89, 12, 0.08)'
                }}
              >
                {/* UPI App Switcher */}
                  ...
                  {UPI_APPS.map(app => (
                    <button
                      ...
                      style={{
                        padding: '6px 10px',
                        borderRadius: '8px',
                        border: selectedUpiApp.id === app.id ? '2px solid #E8590C' : '1px solid #EAE3D9',
                        ...
                        fontSize: '11.5px',
                        fontWeight: 700,
                        color: selectedUpiApp.id === app.id ? '#E8590C' : '#1C1917',
                        whiteSpace: 'nowrap'
                      }}
                    >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <Smartphone size={14} color="#E8590C" />
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{
                          background: 'none',
                          border: 'none',
                          color: isCopiedVpa ? '#2B8A3E' : '#E8590C',
                          fontWeight: 700,
                          cursor: 'pointer',
                          display: 'flex',
                          alignItems: 'center',
                    ...
                    >
                      <Clock size={12} color="#E8590C" />
                      <span>
                        QR expires in: <strong style={{ color: '#E8590C' }}>{minutes}:{seconds}</strong>
                      </span>
                    </div>
                  </div>
                </div>
            ...
            {paymentMethod === 'NETBANKING' && (
              ...
              >
                    ...
                    return (
                      <button
                        ...
                        style={{
                          padding: '10px 8px',
                          borderRadius: '10px',
                          border: isSelected ? '2px solid #E8590C' : '1.5px solid #EAE3D9',
                          background: isSelected ? '#FFF4E6' : '#FFFFFF',
                          cursor: 'pointer',
                          display: 'flex',
                          flexDirection: 'column',
                          alignItems: 'center',
                          gap: '4px',
                          transition: 'all 0.15s ease',
                          boxShadow: isSelected ? '0 2px 8px rgba(232, 89, 12, 0.18)' : 'none'
                        }}
                      >
                        <span style={{ fontSize: '18px' }}>{bank.icon}</span>
                        <span style={{ fontSize: '11px', fontWeight: 800, color: isSelected ? '#E8590C' : '#1C1917', textAlign: 'center', lineHeight: 1.2 }}>
                          {bank.name}
                        </span>
                      </button>
                    );
                ...
                >
                  <Building2 size={24} color="#E8590C" />
                  <div style={{ flex: 1 }}>
            ...
            {paymentMethod === 'COD' && (
              ...
              >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                    <button
                      ...
                      style={{
                        padding: '10px 12px',
                        borderRadius: '10px',
                        border: codMode === 'CASH' ? '2px solid #E8590C' : '1px solid #EAE3D9',
                        background: codMode === 'CASH' ? '#FFF4E6' : '#FFFFFF',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '8px',
                        color: codMode === 'CASH' ? '#E8590C' : '#57534E',
                        fontSize: '12px',
                        fontWeight: 700,
                        transition: 'all 0.15s ease'
                      }}
                    >
                      <Banknote size={18} color={codMode === 'CASH' ? '#E8590C' : '#57534E'} />
                    ...
                    <button
                      ...
                      style={{
                        padding: '10px 12px',
                        borderRadius: '10px',
                        border: codMode === 'UPI_DOORSTEP' ? '2px solid #E8590C' : '1px solid #EAE3D9',
                        background: codMode === 'UPI_DOORSTEP' ? '#FFF4E6' : '#FFFFFF',
                        cursor: 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '8px',
                        color: codMode === 'UPI_DOORSTEP' ? '#E8590C' : '#57534E',
                        fontSize: '12px',
                        fontWeight: 700,
                        transition: 'all 0.15s ease'
                      }}
                    >
                      <QrCode size={18} color={codMode === 'UPI_DOORSTEP' ? '#E8590C' : '#57534E'} />
                ...
                {codMode === 'UPI_DOORSTEP' && (
                  ...
                  >
                    <div style={{ fontSize: '12px', fontWeight: 800, color: '#E8590C', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <Smartphone size={15} color="#E8590C" />
              ...
              style={{
                ...
                background:
                  paymentMethod === 'COD'
                    ...
                    : 'linear-gradient(135deg, #E8590C 0%, #FA8C16 100%)',
                color: '#FFFFFF',
                fontWeight: 800,
                fontSize: '14px',
