          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '18px' }}>
            <div
              style={{
                ...
                height: '64px',
                borderRadius: '20px',
                background: isOnline ? 'linear-gradient(135deg, #E8590C 0%, #D9480F 100%)' : '#44403C',
                display: 'flex',
                alignItems: 'center',
      ...
      <div style={{ display: 'flex', gap: '10px', borderBottom: '2px solid #EAE3D9', paddingBottom: '12px', marginBottom: '24px' }}>
        <button
          ...
          style={{
            ...
            borderRadius: '12px',
            border: 'none',
            background: activeTab === 'active' ? '#E8590C' : 'transparent',
                ...
                >
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '20px' }}>
                    ...
                    <div style={{ background: '#FAF8F5', padding: '16px', borderRadius: '14px', border: '1px solid #EAE3D9' }}>
                      <div style={{ fontSize: '11px', fontWeight: 800, color: '#E8590C', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '4px' }}>
      ...
      {callModalTarget && (
        ...
        >
          ...
          >
            ...
            >
              <Phone size={30} color={callModalTarget.type === 'cook' ? '#E8590C' : '#4F46E5'} />
            </div>

            <span
              style={{
                background: callModalTarget.type === 'cook' ? '#FFF4E6' : '#EEF2FF',
                color: callModalTarget.type === 'cook' ? '#E8590C' : '#4F46E5',
                padding: '3px 12px',
                borderRadius: '9999px',
                fontSize: '11.5px',
                fontWeight: 800,
