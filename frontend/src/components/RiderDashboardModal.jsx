            ...
            {orders.map((ord) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: '#FFFFFF',
                    border: `1.5px solid ${isDone ? '#E2E8F0' : '#E8590C'}`,
                    borderRadius: '16px',
                    padding: '16px 18px',
                    boxShadow: isDone ? 'none' : '0 4px 14px rgba(232, 89, 12, 0.12)',
                ...
                >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      <span
                        style={{
                          ...
                          background: isDone ? '#EBFBEE' : '#FFF4E6',
                          color: isDone ? '#2B8A3E' : '#E8590C',
                          fontWeight: 800,
                          fontSize: '11.5px',
                          padding: '3px 10px',
                          borderRadius: '9999px',
                  ...
                  >
                    ...
                    <span style={{ color: '#E8590C', fontWeight: 700 }}>304 Insulated Steel Dabba</span>
                  </div>
