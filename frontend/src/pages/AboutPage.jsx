    ...
    <div style={{ background: '#FAF8F5', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <section style={{ padding: '60px 20px 40px', textAlign: 'center', maxWidth: '880px', margin: '0 auto' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '6px 16px', borderRadius: '9999px', fontSize: '12px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '14px', border: '1px solid rgba(232, 89, 12, 0.25)' }}>
          <Sparkles size={13} />
          <span>About HomeFeast</span>
        </div>

        <h1 style={{ fontSize: '40px', fontWeight: 900, color: '#1C1917', letterSpacing: '-0.03em', lineHeight: 1.2, margin: '0 0 16px 0' }}>
          Pioneering Homemade <br />
          <span style={{ background: 'linear-gradient(135deg, #E8590C 0%, #FA8C16 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Tiffin & Homestyle Food Revolution
          </span>
        </h1>
      ...
      <div className="container">
        ...
        >
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '4px 12px', borderRadius: '9999px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '10px' }}>
              <span>Our Story</span>
            </div>
            <h2 style={{ fontSize: '28px', fontWeight: 900, color: '#1C1917', lineHeight: 1.3, marginBottom: '14px' }}>
              Started with a <span style={{ color: 'var(--primary)' }}>Simple Idea</span>
            </h2>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              <ShieldCheck size={20} color="#E8590C" />
        ...
        <div style={{ marginBottom: '60px' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <span style={{ background: '#FFF4E6', color: '#E8590C', padding: '4px 12px', borderRadius: '9999px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase' }}>
              Our Promise
            </span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
            <div className="card-clean" style={{ padding: '24px', borderRadius: '18px', border: '1px solid #EAE3D9' }}>
              <div style={{ width: '42px', height: '42px', borderRadius: '10px', background: '#FFF4E6', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
