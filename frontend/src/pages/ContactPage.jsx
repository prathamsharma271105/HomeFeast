  ...
  return (
    <div style={{ background: '#FAF8F5', minHeight: '100vh', paddingBottom: '80px' }}>
      ...
      <section style={{ padding: '60px 20px 40px', textAlign: 'center', maxWidth: '840px', margin: '0 auto' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '6px 16px', borderRadius: '9999px', fontSize: '12px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '14px', border: '1px solid rgba(232, 89, 12, 0.25)' }}>
          <Sparkles size={13} />
          <span>Get In Touch</span>
        </div>

        <h1 style={{ fontSize: '38px', fontWeight: 900, color: '#1C1917', letterSpacing: '-0.03em', lineHeight: 1.2, margin: '0 0 14px 0' }}>
          We'd Love to <br />
          <span style={{ background: 'linear-gradient(135deg, #E8590C 0%, #FA8C16 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Hear From You
          </span>
        </h1>
      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            >
              <Mail size={24} color="#E8590C" />
            </div>
            <h3 style={{ fontSize: '17px', fontWeight: 800, color: '#1C1917', marginBottom: '8px' }}>
              Email Us
            </h3>
            <a href="mailto:care@homefasttiffin.in" style={{ fontSize: '14px', fontWeight: 700, color: '#1C1917', textDecoration: 'none', display: 'block' }}>
              care@homefasttiffin.in
            </a>
            <a href="mailto:chef@homefasttiffin.in" style={{ fontSize: '13px', color: '#78716C', textDecoration: 'none', marginTop: '2px', display: 'block' }}>
              chef@homefasttiffin.in
            </a>
            <span style={{ fontSize: '11px', color: '#E8590C', fontWeight: 700, marginTop: '10px', background: '#FFF4E6', padding: '3px 10px', borderRadius: '9999px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px' }}>
          ...
          >
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '4px 12px', borderRadius: '9999px', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '8px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                ...
                <span style={{ background: '#FFF4E6', color: '#E8590C', fontSize: '11px', fontWeight: 700, padding: '2px 8px', borderRadius: '6px' }}>
                  26 Delivery Hubs
                </span>
              </div>
            ...
            <div style={{ background: 'linear-gradient(135deg, #1C1917 0%, #292524 100%)', color: '#FFFFFF', padding: '20px 24px', borderRadius: '18px', display: 'flex', alignItems: 'center', gap: '14px' }}>
              <ShieldCheck size={32} color="#E8590C" />
              <div>
