    ...
    <div style={{ paddingBottom: '80px' }}>
      ...
      >
        <div style={{ maxWidth: '1240px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px', alignItems: 'center' }}>
          <div>
            ...
            >
              Homemade Food. <br />
              <span style={{ color: '#E8590C' }}>Made With Care.</span>
            </h1>
            ...
            >
              <div style={{ position: 'relative', height: '340px', borderRadius: '20px', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', bottom: '16px', left: '16px', right: '16px', color: '#FFFFFF' }}>
                  <span style={{ background: '#E8590C', padding: '3px 10px', borderRadius: '8px', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase' }}>
      ...
      <section style={{ maxWidth: '1240px', margin: '60px auto 0 auto', padding: '0 16px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <span style={{ fontSize: '12px', fontWeight: 800, color: '#E8590C', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
            AUTHENTIC FLAVORS
          </span>
          ...
          {featuredProviders.map(prov => (
            ...
            >
              <div style={{ position: 'relative', height: '180px', background: '#F3ECE2' }}>
                ...
                <span
                  style={{
                    ...
                    top: '12px',
                    left: '12px',
                    background: prov.mealType === 'veg' ? '#2B8A3E' : prov.mealType === 'jain' ? '#D97706' : '#E8590C',
                    color: '#FFFFFF',
                    padding: '3px 8px',
                    borderRadius: '6px',
                    fontSize: '11px',
              ...
              <div style={{ padding: '18px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                ...
                <div style={{ fontSize: '12px', color: '#E8590C', fontWeight: 700, marginBottom: '6px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
            {[
              ...
              return (
                ...
                >
                  <div style={{ fontSize: '32px', fontWeight: 900, color: '#FDBA74', position: 'absolute', top: '16px', right: '16px' }}>
                    {item.step}
                  </div>
                  <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: '#FFF4E6', color: '#E8590C', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '16px' }}>
                    <Icon size={24} />
                  </div>
          ...
          <div>
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '8px',
                boxShadow: '0 4px 16px rgba(232, 89, 12, 0.4)'
              }}
            >
              <ChefHat size={18} />
