    ...
    <button
      ...
      style={{
        ...
        background: isActive
          ...
          ? '#FFF9F2'
          : '#FFFFFF',
        color: isActive || isHovered ? '#E8590C' : '#44403C',
        fontSize: '12.5px',
    ...
    <button
      ...
      style={{
        ...
        background: isActive
          ...
          ? '#FFF9F2'
          : '#FFFFFF',
        color: isActive || isHovered ? '#E8590C' : '#57534E',
        fontSize: '12px',
        fontWeight: isActive ? 800 : 700,
        cursor: 'pointer',
        transition: 'all 0.15s ease',
        boxShadow: isActive || isHovered ? '0 2px 8px rgba(232, 89, 12, 0.15)' : 'none',
        outline: 'none',
        textAlign: 'center'
      }}
    >
    ...
    <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '24px 16px 80px 16px' }}>
      ...
      <div style={{ marginBottom: '28px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '16px' }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '4px 12px', borderRadius: '16px', fontSize: '12px', fontWeight: 800, marginBottom: '6px' }}>
              <ChefHat size={15} />
        ...
        {isFilterDrawerOpen && (
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <button onClick={resetFilters} style={{ fontSize: '11px', color: '#E8590C', fontWeight: 700, border: 'none', background: 'none', cursor: 'pointer' }}>
                Clear All
              </button>
            </div>
                ...
                >
                  ...
                  <div style={{ position: 'relative', height: '190px', background: '#F5F5F4' }}>
                    ...
                    <div style={{ position: 'absolute', top: '12px', left: '12px' }}>
                      <span
                        style={{
                          background: prov.mealType === 'jain' ? '#E8590C' : prov.mealType === 'veg' ? '#2B8A3E' : '#C92A2A',
                          color: '#FFFFFF',
                          padding: '4px 10px',
                          borderRadius: '8px',
                          fontSize: '11px',
                    ...
                    <div style={{ position: 'absolute', bottom: '12px', left: '12px', right: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '4px', background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(4px)', padding: '4px 8px', borderRadius: '8px', color: '#FFFFFF', fontSize: '12px', fontWeight: 700 }}>
                        <Star size={13} fill="#FA8C16" color="#FA8C16" />
                  ...
                  <div style={{ padding: '18px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                    ...
                    <div style={{ fontSize: '12px', color: '#E8590C', fontWeight: 700, marginBottom: '8px' }}>
