    ...
    <button
      ...
      style={{
        ...
        background: isActive
          ...
          ? '#FFF9F2'
          : '#FFFFFF',
        color: isActive || hover ? '#E8590C' : '#44403C',
        fontSize: '12.5px',
              ...
              return (
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    borderRadius: '12px',
                    border: isDayActive ? '2px solid #E8590C' : '1px solid #EAE3D9',
                    background: isDayActive ? '#E8590C' : '#FFFFFF',
                    color: isDayActive ? '#FFFFFF' : '#57534E',
                    fontSize: '13px',
                    fontWeight: isDayActive ? 800 : 600,
                    cursor: 'pointer',
                    transition: 'all 0.15s ease',
                    boxShadow: isDayActive ? '0 4px 12px rgba(232, 89, 12, 0.3)' : 'none',
                    whiteSpace: 'nowrap'
                  }}
                >
                  {d.label}
          ...
          <div style={{ display: 'flex', background: '#F5F5F4', padding: '4px', borderRadius: '12px', gap: '4px' }}>
            <button
              ...
              style={{
                ...
                color: selectedSlot === 'lunch' ? '#E8590C' : '#78716C',
                fontWeight: 800,
                fontSize: '12.5px',
                cursor: 'pointer',
                display: 'flex',
            ...
            >
              <Sun size={15} color={selectedSlot === 'lunch' ? '#E8590C' : '#78716C'} />
            ...
            <button
              ...
              style={{
                ...
                color: selectedSlot === 'dinner' ? '#E8590C' : '#78716C',
                fontWeight: 800,
                fontSize: '12.5px',
                cursor: 'pointer',
                display: 'flex',
            ...
            >
              <Moon size={15} color={selectedSlot === 'dinner' ? '#E8590C' : '#78716C'} />
                ...
                >
                  ...
                  <div style={{ position: 'relative', height: '185px', background: '#F5F5F4' }}>
                    ...
                    {meal.isChefSpecial && (
                      <div style={{ position: 'absolute', top: '12px', right: '12px' }}>
                        ...
                        >
                          <Award size={13} color="#E8590C" /> Chef's Special
                        </span>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ padding: '18px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                    ...
                    {meal.items && meal.items.length > 0 && (
                      <div style={{ background: '#FFF9F2', borderRadius: '10px', padding: '10px 12px', marginBottom: '12px', border: '1px solid #FFE8CC' }}>
                        <div style={{ fontSize: '11px', fontWeight: 800, color: '#E8590C', textTransform: 'uppercase', marginBottom: '6px' }}>
                    ...
                    <div style={{ borderTop: '1px solid #F5F5F4', paddingTop: '12px', marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
                          <span style={{ fontSize: '20px', fontWeight: 900, color: '#E8590C' }}>
                            ₹{meal.price}
                          </span>
                          {meal.originalPrice && (
