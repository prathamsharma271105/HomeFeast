...
const getOrderBadgeMeta = (status) => {
  ...
  if (s === 'COOKING' || s === 'PREPARING') {
    return { bg: '#FFF4E6', color: '#D97706', text: '🔥 COOKING FRESH' };
  }
    ...
    <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '24px 16px 80px 16px' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#FFF4E6', color: '#E8590C', padding: '3px 12px', borderRadius: '12px', fontSize: '12px', fontWeight: 800, marginBottom: '4px' }}>
              <User size={14} />
      ...
      <div style={{ display: 'flex', gap: '8px', borderBottom: '2px solid #EAE3D9', marginBottom: '24px', overflowX: 'auto' }}>
        {[
          ...
          return (
            ...
            >
              <Icon size={16} color={isActive ? '#E8590C' : '#78716C'} />
              <span>{tab.label}</span>
            </button>
          );
        })}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
            <div style={{ background: '#FFFFFF', padding: '20px', borderRadius: '20px', border: '1px solid #EAE3D9', boxShadow: '0 2px 10px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ fontSize: '22px', fontWeight: 900, color: '#E8590C', margin: '4px 0' }}>
            ...
            <div style={{ background: '#FFFFFF', padding: '20px', borderRadius: '20px', border: '1px solid #EAE3D9', boxShadow: '0 2px 10px rgba(0,0,0,0.03)' }}>
              ...
              <div style={{ fontSize: '12px', color: '#E8590C', fontWeight: 700 }}>★ 4.96 Verified Rating</div>
            </div>
          </div>
            ...
            <div style={{ background: '#FFFFFF', borderRadius: '24px', border: '1px solid #EAE3D9', padding: '24px', boxShadow: '0 4px 16px rgba(0,0,0,0.04)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontSize: '14px', fontWeight: 800, color: '#E8590C' }}>{sub.mealSlot}</div>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      <div style={{ textAlign: 'right', marginRight: '8px' }}>
                        <div style={{ fontSize: '16px', fontWeight: 900, color: '#E8590C' }}>₹{o.totalAmount}</div>
          ...
          {allSubscriptions.map(s => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px', marginBottom: '16px' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: '24px', fontWeight: 900, color: '#E8590C' }}>₹{s.price}</div>
              ...
              <div style={{ background: '#FAF8F5', padding: '14px', borderRadius: '14px', marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', fontWeight: 700, marginBottom: '6px' }}>
                  ...
                  <span style={{ color: '#E8590C' }}>Meals Left: {s.remainingMeals !== undefined ? s.remainingMeals : s.totalMeals}</span>
                </div>
            ...
            >
              ...
              <div style={{ background: '#FAF8F5', borderRadius: '12px', padding: '12px', marginBottom: '14px', fontSize: '13px' }}>
                ...
                <div style={{ borderTop: '1px solid #EAE3D9', marginTop: '8px', paddingTop: '8px', display: 'flex', justifyContent: 'space-between', fontWeight: 800 }}>
                  ...
                  <span style={{ color: '#E8590C' }}>₹{o.totalAmount}</span>
                </div>
              </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '12px', color: '#78716C', marginTop: '2px' }}>
                      ...
                      {r.favoriteDish && <span> • Fav: <span style={{ color: '#E8590C' }}>{r.favoriteDish}</span></span>}
                    </div>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '3px', background: '#FFF9F2', padding: '4px 8px', borderRadius: '8px', border: '1px solid #FED7AA' }}>
                    ...
                    <span style={{ fontSize: '12px', fontWeight: 800, color: '#D97706', marginLeft: '4px' }}>{r.rating}.0</span>
                  </div>
                </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span
                      style={{
                        ...
                        color: c.priority === 'HIGH' ? '#DC2626' : c.priority === 'MEDIUM' ? '#D97706' : '#4B5563'
                      }}
                    >
      ...
      {activeTab === 'profile' && (
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(260px, 300px) 1fr', gap: '24px', alignItems: 'flex-start' }}>
